...
import co.edu.uniminuto.ArqSW.MarketPlaceTurismPackage.hibernate.Registro;
...
public class RegistroDAO {
    ...
    //-----------------------------------------------------------------------//
    /**
     * Add new log registry
     *
     * @param Registro
     */
    public boolean addRegistro(Registro object) {
        boolean flag = false;
        try {
    ...
    /**
     * Update a log registry
     *
     * @param Registro
     */
    public boolean updateRegistro(Registro object) {
        boolean flag = false;
        try {
            transaction = session.beginTransaction();
    ...
    /**
     * delete especific log registry
     *
     * @param int identifier Registro
     */
    ...
    /**
     * List of log registrys generics
     *
     * @return List <Registro>
     */
    public List<Registro> getRegistro() {
        List<Registro> objectsList = new ArrayList<Registro>();
        try {
            transaction = session.beginTransaction();
            query = session.createQuery("from Registro");
            objectsList = (List<Registro>) query.list();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return objectsList;
