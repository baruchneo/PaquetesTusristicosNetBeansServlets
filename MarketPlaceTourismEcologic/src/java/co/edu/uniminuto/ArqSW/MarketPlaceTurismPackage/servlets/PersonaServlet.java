...
import co.edu.uniminuto.ArqSW.MarketPlaceTurismPackage.DAO.PersonaDAO;
...
public class PersonaServlet extends HttpServlet 
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        String msg = listarResultado(personas);
        ...
        try 
        {
            ...
            out.println("</div>");
            out.println("</ol>");
            out.println("<div class=\"content\" id=\"grid\" style=\"margin-left: 30px;\">");
    ...
    //                              Private Methods                          //
    //-----------------------------------------------------------------------//
    private String listarResultado(List<Persona> personas) 
    {
        String result = "";
        result += "<table border=\"1\">";
        result += "<tr>";
        result += "<td>Nombres</td>";
        result += "<td>Apellidos</td>";
        result += "<td>T. Doc</td>";
        result += "<td>Docuemnto</td>";
        result += "<td>Fech. Nac.</td>";
        result += "<td>Celular</td>";
        result += "<td>Telefono</td>";
        result += "<td>Estado</td>";
        result += "<td>Usuario</td>";
        result += "<td>clave</td>";
        for (Persona persona : personas) 
        {
            result += "<tr>";
            result += "<td>" + persona.getNombres() + "</td>";
            result += "<td>" + persona.getAppellidos() + "</td>";
            result += "<td>" + persona.getTipoDocumento() + "</td>";
            result += "<td>" + persona.getNumDocumento() + "</td>";
            result += "<td>" + persona.getFechaNacimiento() + "</td>";
            result += "<td>" + persona.getTelefonoMovil() + "</td>";
            result += "<td>" + persona.getTelefono() + "</td>";
            result += "<td>" + persona.getEstado() + "</td>";
            result += "<td>" + persona.getUsuario() + "</td>";
            result += "<td>" + persona.getClave() + "</td>";
            result += "</tr>";
        }
        result += "</tr>";
        result += "</table>";
